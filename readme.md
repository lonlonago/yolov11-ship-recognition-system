# YOLOv11 Ship Recognition System

## Body

YOLOv11 Ship Detection System Based on Deep Learning YOLOv11: A Ship Type Recognition and Detection System (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)
...
Dataset quantity: training set 3498 images, validation set 1000 images, test set 500 images.
